    ...
    >
      <div className="mx-auto flex flex-col gap-8 sm:gap-12 md:gap-16">
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="bg-secondary rounded-xl border-none p-4 sm:p-6 shadow-none hover:bg-muted/50 transition-colors">
          ...
          <Card className="bg-secondary rounded-xl border-none p-4 sm:p-6 shadow-none hover:bg-muted/50 transition-colors md:col-span-2 lg:col-span-1">
            <CardContent className="flex flex-col gap-4 sm:gap-6 text-center p-0">
              <div className="flex flex-col gap-2 sm:gap-3">
                <h3 className="text-primary font-semibold text-lg sm:text-xl">
                  Autonomie
                ...
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                  Tes chiffres, tes règles. Personnalise ta formule d'épargne et
                  ton calcul dépensable.
                </p>
              </div>
            </CardContent>
          </Card>
